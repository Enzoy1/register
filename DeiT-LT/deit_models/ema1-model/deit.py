...
class DistilledVisionTransformer(VisionTransformer):
    def __init__(self, crt=None, ema_open=False, *args, **kwargs):
        super().__init__(*args, **kwargs, ema_open=ema_open)
...
@register_model
def deit_base_distilled_patch16_224(pretrained=False,ema_open=False, **kwargs):
    model = DistilledVisionTransformer(
        patch_size=16,
        embed_dim=768,
        depth=12,
